    ...
    <header className="bg-white shadow-md py-4">
      <div className="container mx-auto flex justify-between items-center px-4">
        <div className="flex items-center space-x-4">
          ...
          <Link to="/practice-dashboard" className="text-wood-darker font-bold">
            Practica Estrategica
          </Link>
          <Link to="/normative-aspects-dashboard" className="text-wood-darker font-bold">
            Aspectos Normativos
          </Link>
          <Link to="/carinnovation-dashboard" className="text-wood-darker font-bold">
            Car Innovacion
          </Link>
          <Link to="/university-dashboard" className="text-wood-darker font-bold">
            Universidad
          </Link>
          <Link to="/focus-dashboard" className="text-wood-darker font-bold">
            Enfoque
          </Link>
          {isLogged && (
            <>
