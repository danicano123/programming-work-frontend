...
const ProgrammPracticeStrategyDetail: React.FC = () => {
  const { id } = useParams();
  ...
  if (!programmPracticeStrategy) return <div className="text-center py-4">Cargando...</div>;
    ...
    <div className="container mx-auto p-4 max-w-lg">
      ...
      <div className="bg-white p-6 rounded-lg shadow-lg">
        <div className="space-y-4">
          <DetailItem label="Programa" value={programmPracticeStrategy.programmId} />
          <DetailItem label="Practica Estrategica" value={programmPracticeStrategy.practiceStrategyId} />
        </div>
...
export default ProgrammPracticeStrategyDetail;
