...
const CreateProgrammAreaKnowledge: React.FC = () => {
  ...
  const validationSchema = Yup.object({
    ...
    areaKnowledgeId: Yup.number().required("Campo requerido"),
  });
  ...
  return (
    <div className="container mx-auto p-4">
      <h1 className="text-2xl font-bold mb-4">Crear Programa Area Conocimiento</h1>
...
export default CreateProgrammAreaKnowledge;
