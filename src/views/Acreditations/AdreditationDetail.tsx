    ...
    <div className="container mx-auto p-4 max-w-lg">
      ...
      <div className="bg-white p-6 rounded-lg shadow-lg">
        <div className="space-y-4">
          <DetailItem label="Nombre" value={acreditation.type} />
          <DetailItem label="Tipo" value={acreditation.calification} />
          <DetailItem label="Ciudad" value={acreditation.date_init} />
          <DetailItem label="Ciudad" value={acreditation.date_end} />
        </div>
