...
const QualifiedRegistrationDetail: React.FC = () => {
  const { id } = useParams();
  ...
  if (!qualifiedregistration) return <div className="text-center py-4">Cargando...</div>;
...
export default QualifiedRegistrationDetail;
